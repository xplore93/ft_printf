...
#    Updated: 2019/11/23 20:09:29 by estina           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =		flag_minus_handle.c		flag_none_handle.c				\
			...
			handle_char.c			handle.c						\
			handle_percent.c		handle_pointer.c				\
...
SRCS_LIB =	ft_putstr_fd.c		ft_putchar_fd.c		ft_strdup.c		\
			ft_strlen.c			ft_itoa.c			ft_strchr.c		\
			ft_atoi.c			ft_isdigit.c		ft_substr.c		\
