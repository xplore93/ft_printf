...
/*   Updated: 2019/11/26 01:24:39 by estina           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	ft_sum_digits(unsigned long long int *num, int *num_digits)
{
	while (*num >= 10)
	{
		(*num_digits)++;
...
static char	*ft_malloc_number(long long int n, int *num_digits)
{
	char					*number;
